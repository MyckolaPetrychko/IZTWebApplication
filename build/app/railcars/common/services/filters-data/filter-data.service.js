...
var DataFilterService = (function () {
     ...
     */
    function DataFilterService(_http) {
        this._http = _http;
    }
    /**
     *
     ...
     * @returns {(Observable<IDataModel | string>)}
     */
    DataFilterService.prototype.getCultureClassesList = function (cultureID) {
        var _url = filter_data_constant_1.CulturesClassesApi.url.replace('%cultureID%', '' + cultureID);
        return this._getFiltersHttp(_url, filter_data_constant_1.CulturesClassesApi.idValue, filter_data_constant_1.CulturesClassesApi.nameValue);
    };
    /**
     *
     *
     * @returns {(Observable<IDataModel | string>)}
     */
    DataFilterService.prototype.getCultureSortesList = function (cultureID) {
        var _url = filter_data_constant_1.CulturesSortesApi.url.replace('%cultureID%', '' + cultureID);
        return this._getFiltersHttp(_url, filter_data_constant_1.CulturesSortesApi.idValue, filter_data_constant_1.CulturesSortesApi.nameValue);
    };
    /**
     *
     *
