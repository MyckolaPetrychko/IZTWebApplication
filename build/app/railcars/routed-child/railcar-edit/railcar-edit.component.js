...
var RailcarEditComponent = (function () {
    ...
    RailcarEditComponent.prototype.loadDataForFilters = function () {
        ...
        this._filters.getCultureClassesList().subscribe(function (val) {
            _this._classes = val;
        });
        this._filters.getCultureSortesList().subscribe(function (val) {
            _this._sorts = val;
        });
    ...
    RailcarEditComponent = __decorate([
        core_1.Component({
            ...
            directives: [data_combobox_component_1.DataComboboxComponent, alert_component_1.AlertComponent, forms_1.FORM_DIRECTIVES, my_date_picker_component_1.MyDatePicker, railcar_number_validator_1.RailcarNumberValidator]
        }), 
